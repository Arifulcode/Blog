                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            ...
                            <h3 class="card-title">Create Category-{{ $category->name }}</h3>
                            <div>
                                <a href="{{ route('category.index') }}" class="btn btn-sm btn-primary">Go Bacak to
                                    Category List</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <form action="{{ route('category.update', [$category->id]) }}" method="post">
                                    ...
                                    <!-- @include('includes.errors') -->
                                        <div class="form-group">
                                            ...
                                            <input type="name" name="name" class="form-control" id="name"  value="{{$category->name}}"
